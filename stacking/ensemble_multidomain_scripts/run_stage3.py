...
from data_util import load_stage3_data
...
def main():
    ...
    if args.method == 'svgp':
        ...
        if args.use_opt:
            param_file = Path('../out/ensemble-multidomain/opt_hp_stage3') / args.datatrack / \
                            f'{args.method}-{args.feat_type}' / 'params.json'
    ...
    out_dir = Path('../out/ensemble-multidomain/stage3') / args.datatrack / \
                    f'{args.method}-{args.feat_type}' / str(args.i_cv)
