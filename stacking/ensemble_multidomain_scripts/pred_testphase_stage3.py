...
from data_util import load_stage3_data, load_stage3_test_data
...
def main():
    ...
    model_dir = Path('../out/ensemble-multidomain/stage3') / args.train_datatrack / \
    ...
    pred_data = {}
    pred_data['test'] = load_stage3_test_data(
