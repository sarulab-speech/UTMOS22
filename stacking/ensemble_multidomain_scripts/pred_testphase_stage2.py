...
from data_util import load_stage2_data, load_stage2_test_data
...
def main():
    ...
    model_dir = Path('../out/ensemble-multidomain/stage2') / args.train_datatrack / \
    ...
    pred_data = {}
    pred_data['test'] = load_stage2_test_data(
