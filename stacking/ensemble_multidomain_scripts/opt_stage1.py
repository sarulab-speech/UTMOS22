...
from data_util import load_stage1_train_all_data
...
def main():
    ...
    data = load_stage1_train_all_data(
    ...
    if args.method == 'ridge':
        ...
        model = LinearSVR(stage='stage1')
    elif args.method == 'kernel_svr':
        model = KernelSVR(stage='stage1')
    elif args.method == 'rf':
    ...
    out_dir = Path('../out/ensemble-multidomain/opt_hp_stage1') / args.datatrack / \
                    f'{args.method}-{args.ssl_type}'
